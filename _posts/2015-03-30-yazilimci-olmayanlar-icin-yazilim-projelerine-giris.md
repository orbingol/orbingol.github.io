...
Burada size *bilmemkimin bilmemne projesi süper gitmişti* şeklinde örnekler vermeyeceğim. Bu tür örneklerin başlangıç aşamasında değerlendirilmesinin yanlış olduğunu düşünüyorum, ancak proje uygulayarak kazandığınız tecrübeyi rötuşlamak için bu örnekleri kullanmanızı tavsiye edebilirim. 

Sizin de tahmin edeceğiniz gibi, bu işin her zaman kitabına uygun gittiğini söylemem oldukça zor. Günümüzde *başarılı projeler*, *şanslı projeler*, *başarısız projeler* ve *şanssız projeler* gibi çeşitli proje türlerini gözlemlemek mümkün. Başarılı projeler hakkında çoğu yerde değişik yazılar okuyabilirsiniz. Şanslı projeleri başarılı olarak değerlendirenleri de gözlemlersiniz ama olmayabilirler. Başarısız projeleri ise genelde ders kitaplarında okursunuz, eğer uygun bölüm veya dersleri bulabilirseniz. Şanssız projeleri ise sadece projeyi yapanlardan dinleyebilirsiniz. 

Eğer siz de başarılı bir proje üretmek istiyorsanız, bazı unsurlara dikkat etmeniz gerekiyor. Bu unsurların hepsinden bahsetmek çok zor, bir kısmını da yaparak öğrenmeniz gerekebilir. Basit olarak, herkesin kendinden bir parçayı ortaya dökmesi ve diğerlerinin de bu dökülenlerin hakkını vermesi gerekiyor gibi bir özet geçebiliriz. Bu noktada, belki, **The Toyota Way (Toyota Yolu)** konusunda bir araştırma yapmanız faydalı olabilir. Her ne kadar otomobil endüstrisi ile ilgili olsa da, temelinde *sürekli iyileştirme* ve *insanlara saygı* gibi iki temel noktayı barındıran prensipler, bu konuda bilgili veya fikri olmayan yöneticiler için başlangıç noktası olabilir. Ayrıca, [ilgili Wikipedia makalesi](http://en.wikipedia.org/wiki/The_Toyota_Way)ne de bakabilirsiniz.

Örnek başlığı altında örnek vermekten çekinmiş gibi görünüyor olabilirim. Evet, herkesin bildiği örnekleri vermekten çekindim. Yine de hızlıca bakıp görebileceğiniz bir örnekten bahsedeceğim: oDesk'te bulunan ilanların bir kısmında *I have specifications* şeklinde notlar görebilirsiniz. oDesk'in kendisi de, bu şekilde önçalışma yapılmayan projelere pek ilgi gösterilmediğini belirtmekte zaten. Her ne kadar yazılım işleri bir parça hor görülüp, yan işmiş gibi lanse edilse de, internet üzerinden verilen servislerde ve e-ticaret gibi uygulamalarda yazılım doğrudan bu işin belkemiği durumunda olabiliyor. Bu yüzden, yazılım yoğunluklu (software intensive) bir çalışma yapıldığında, buna gerekli özeni göstermek **zorundasınız**.
