---
title: AiToS
summary: Experimental ATS-style resume analyzer with a web UI and CLI, powered by local models via Ollama.
description: AiToS analyzes resumes against job descriptions with local AI models, simulating ATS-style scoring.
...
- GitHub: [https://github.com/orbingol/aitos](https://github.com/orbingol/aitos)
